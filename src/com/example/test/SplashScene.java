...
public class SplashScene extends Scene {
	...
	public SplashScene() {
		...
		setBackground(activity.dogeBackgroundTexture);
		...
		title1.registerEntityModifier(new MoveXModifier(4, title1.getX(),
				(activity.mCamera.getWidth() / 2) - title1.getWidth()));
		title2.registerEntityModifier(new MoveXModifier(4, title2.getX(),
	...
	void loadResources() {
		DelayModifier dMod = new DelayModifier(6,
